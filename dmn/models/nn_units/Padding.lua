local Padding, parent = torch.class('dmn.Padding', 'nn.Module')

-- Dynamically pads input by specified value: Makes sure padding size will 
-- add up to specified amount.
